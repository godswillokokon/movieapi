class UI {
  ...
  showLocations(locationsObject) {
    console.log(locationsObject);
    const { info, results } = locationsObject;
              ...
              <div class="card-body">
                ...
                <div href="#" class="list-group-item list-group-item-action list-group-item-dark bg-dark">
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <small class="mb-1 text-warning">${result.id}</small>
                  </div>
                </div>
                ...
                <div href="#" class="list-group-item list-group-item-action list-group-item-dark bg-dark">
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <small class="mb-1 text-warning">${result.name}</small>
                  </div>
                </div>
                ...
                <div href="#" class="list-group-item list-group-item-action list-group-item-dark bg-dark">
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <small class="mb-1 text-warning">${result.type}</small>
                  </div>
                </div>
                ...
                <div href="#" class="list-group-item list-group-item-action list-group-item-dark bg-dark">
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <small class="mb-1 text-warning">${result.dimension}</small>
                  </div>
                </div>
                ...
                <div href="#" class="list-group-item list-group-item-action list-group-item-dark bg-dark">
                  <div class="d-flex w-100 justify-content-between">
                    ...
                    <small class="mb-1 text-warning">${result.residents.length}</small>
                  </div>
                </div>
